...
No final desta página, apresentamos dois exemplos de protótipos criados usando esta ferramenta, incluindo documentações sobre uso da ferramenta e desenvolvimento dos protótipos.
...
***
## Trasher Drop (Protótipo desenvolvido com a ferramenta GDevelop) 

Em Trasher Drop, um jogo de clicar e arrastar, o jogador assume o desafio de organizar a cidade por meio da coleta e separação correta dos resíduos que caem do céu antes que poluam o ambiente. O objetivo é identificar o tipo de lixo e destiná-lo à lixeira correta, acumulando pontos e aprendendo sobre sustentabilidade e coleta seletiva. Com fases progressivamente mais rápidas e desafiadoras, o jogo multiplataforma promove de forma lúdica a conscientização ambiental, estimulando crianças e adolescentes a refletirem sobre suas próprias práticas de descarte e a importância de pequenas ações para um futuro mais sustentável.
...
Disponível a um click de distância, o protótipo [Envionment Invasion](https://gd.games/games/b53a2417-1569-4dda-a53e-8db16ca18f08) está aberto para testes, sendo criado a partir da ferramenta [GDevelop](https://gdevelop.io/pt-br). Além disso, há documentações disponíveis, como o [Game Design Document](https://docs.google.com/document/d/196kwJROZbSXgfig7sXU62AE_DWjzs5BS/edit?usp=sharing&ouid=116833630896248214855&rtpof=true&sd=true), voltado para o planejamento do protótipo, e o [Creation Diary](https://docs.google.com/document/d/1zxf-ApRCeNABWKPL8z5iJo_PGBZo1ODs/edit?usp=sharing&ouid=116833630896248214855&rtpof=true&sd=true), destinado ao registro de execução do protótipo.
